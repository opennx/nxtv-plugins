...
FONT_TICKER = 'TeXGyreHeros 34'

def Plugin(NXCGPlugin):
    def on_init(self):
        self.colors.update(NX_COLOR_PRESETS)
    ...
    def clock(self,tstamp):
        self.cg.set_color("black")
        self.rect(1700, self.SAFET, 1920, 48)
        self.set_font(FONT_TICKER)
